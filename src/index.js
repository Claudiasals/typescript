...
function addTodo(title, metadata2) {
...
var newTodo = addTodo("Nuovo todo", "ciao");
var newTodo2 = addTodo("Nuovo todo 2", "secondo parametro");
var newTodo3 = addTodo("Nuovo todo 3", "secondo parametro obbligatorio");
var userId = 101; // scegli un numero a caso per simulare un utente
...
var updates = { title: "Nuovo titolo" };
...
function createProject(users, todos) {
    ...
    return {
        users: users, // assegna la lista di utenti passata come parametro
        todos: todos // assegna la lista di Todo passata come parametro
    };
}
